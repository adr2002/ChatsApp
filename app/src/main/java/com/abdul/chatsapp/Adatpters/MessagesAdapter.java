...
import com.abdul.chatsapp.databinding.DeleteDialogBinding;
import com.abdul.chatsapp.databinding.ReciveLayoutBinding;
import com.abdul.chatsapp.databinding.SendLayoutBinding;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == SentViewHolder.class) {
            ...
            if(message.getFelling() >= 0) {
                viewHolder.binding.feeling.setImageResource(reactions[(int) message.getFelling()]);
                viewHolder.binding.feeling.setVisibility(View.VISIBLE);
            } else {
...
//                    }
                    ...
                    binding.delete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            message.setMessage("You delete this message for you");
                            message.setFelling(-1);
                            Date currentDate = new Date();
...
//                    }
    ...
    public class ReceiverViewHolder extends RecyclerView.ViewHolder {
        ...
        ReciveLayoutBinding binding;

        public ReceiverViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = ReciveLayoutBinding.bind(itemView);
        }
    }
